 ...
 * - I2C_MAXWAIT = 0..32767 number of retries in i2c2_start_wait. 0 means never stop.
 */
 ...
 * Version 1.4:
 * - added "maximum retry" in i2c2_start_wait in order to avoid lockup
 ...
 * - changed i2c2_init to return true if and only if both SDA and SCL are high
...
#ifndef _SOFTI2C2_HPP
#define _SOFTI2C2_HPP   1
...
bool __attribute__ ((noinline)) i2c2_init(void) __attribute__ ((used));

// Start transfer function: <addr> is the 8-bit I2C address (including the R/W
// bit).
// Return: true if the slave replies with an "acknowledge", false otherwise
bool __attribute__ ((noinline)) i2c2_start(uint8_t addr) __attribute__ ((used));

// Similar to start function, but wait for an ACK! Will timeout if I2C_MAXWAIT > 0.
bool  __attribute__ ((noinline)) i2c2_start_wait(uint8_t addr) __attribute__ ((used));
...
// stop condition.
// Return: true if the slave replies with an "acknowledge", false otherwise
bool __attribute__ ((noinline)) i2c2_rep_start(uint8_t addr) __attribute__ ((used));

// Issue a stop condition, freeing the bus.
void __attribute__ ((noinline)) i2c2_stop(void) asm("ass_i2c22_stop") __attribute__ ((used));

// Write one byte to the slave chip that had been addressed
// by the previous start call. <value> is the byte to be sent.
// Return: true if the slave replies with an "acknowledge", false otherwise
bool __attribute__ ((noinline)) i2c2_write(uint8_t value) asm("ass_i2c22_write") __attribute__ ((used));
...
#define I2C2_TIMEOUT_DELAY_LOOPS (I2C_CPUFREQ/1000UL)*I2C_TIMEOUT/4000UL
#if I2C2_TIMEOUT_DELAY_LOOPS < 1
#define I2C_MAX_STRETCH 1
#else
#if I2C2_TIMEOUT_DELAY_LOOPS > 60000UL
#define I2C_MAX_STRETCH 60000UL
#else
#define I2C_MAX_STRETCH I2C2_TIMEOUT_DELAY_LOOPS
#endif
#endif
...
void __attribute__ ((noinline)) i2c2_delay_half(void) asm("ass_i2c22_delay_half")  __attribute__ ((used));
void __attribute__ ((noinline)) i2c2_wait_scl_high(void) asm("ass_i2c22_wait_scl_high")  __attribute__ ((used));

void  i2c2_delay_half(void)
...
void i2c2_wait_scl_high(void)
{
#if I2C_TIMEOUT <= 0
  __asm__ __volatile__
    ("__L2i2c2_wait_stretch: \n\t"
     " sbis %[SCLIN],%[SCLPIN]  ;wait for SCL high \n\t"
#if __AVR_HAVE_JMP_CALL__
     " jmp  __L2i2c2_wait_stretch \n\t"
#else
     " rjmp  __L2i2c2_wait_stretch \n\t"
#endif
  ...
  __asm__ __volatile__
    ( " ldi     r27, %[HISTRETCH]       ;load delay counter \n\t"
      ...
      "__L2wait_stretch_inner_loop: \n\t"
#if __AVR_HAVE_JMP_CALL__
            " call   __L2check_scl_level       ;call check function   ;; 12C \n\t"
#else
            " rcall   __L2check_scl_level       ;call check function   ;; 12C \n\t"
#endif
      " brpl    __L2stretch_done          ;done if N=0           ;; +1 = 13C\n\t"
      " dec     __tmp_reg__             ;dec inner loop counter;; +1 = 14C\n\t"
      " brne    __L2wait_stretch_inner_loop                      ;; +2 = 16C\n\t"
      " sbiw    r26,1                   ;dec outer loop counter \n\t"
      " brne    __L2wait_stretch          ;continue with outer loop \n\t"
      " sen                             ;timeout -> set N-bit=1 \n\t"
#if __AVR_HAVE_JMP_CALL__
      " jmp __L2wait_return              ;and return with N=1\n\t"
#else
      " rjmp __L2wait_return              ;and return with N=1\n\t"
#endif
      "__L2stretch_done:                  ;SCL=1 sensed \n\t"
      " cln                             ;OK -> clear N-bit \n\t"
#if __AVR_HAVE_JMP_CALL__
      " jmp __L2wait_return              ; and return with N=0 \n\t"
#else
      " rjmp __L2wait_return              ; and return with N=0 \n\t"
#endif
      "__L2check_scl_level:                                      ;; call = 3C\n\t"
      " cln                                                    ;; +1C = 4C \n\t"
      " sbic    %[SCLIN],%[SCLPIN]      ;skip if SCL still low ;; +2C = 6C \n\t"
#if __AVR_HAVE_JMP_CALL__
            " jmp    __L2scl_high                                     ;; +0C = 6C \n\t"
#else
            " rjmp    __L2scl_high                                     ;; +0C = 6C \n\t"
#endif
      " sen                                                    ;; +1 = 7C\n\t "
      "__L2scl_high: "
      " nop                                                    ;; +1C = 8C \n\t"
...
#if __AVR_HAVE_JMP_CALL__
            " call    ass_i2c22_wait_scl_high   ;wait until SCL=H\n\t"
#else
            " rcall    ass_i2c22_wait_scl_high   ;wait until SCL=H\n\t"
#endif
#if I2C_PULLUP
...
#if __AVR_HAVE_JMP_CALL__
            " call    ass_i2c22_delay_half      ;wait T/2 \n\t"
            " call    ass_i2c22_write           ;now write address \n\t"
#else
            " rcall    ass_i2c22_delay_half      ;wait T/2 \n\t"
            " rcall    ass_i2c22_write           ;now write address \n\t"
#endif
     " ret"
     : : [SDADDR] "I"  (SDA_DDR), [SDAPIN] "I" (SDA_PIN),
...
bool  i2c2_rep_start(uint8_t addr)
#if I2C_HARDWARE
{
  return i2c2_start(addr);
}
#else
{
  __asm__ __volatile__
...
#if __AVR_HAVE_JMP_CALL__
            " call     ass_i2c22_delay_half  ;delay  T/2 \n\t"
#else
            " rcall     ass_i2c22_delay_half  ;delay  T/2 \n\t"
#endif
     " cbi  %[SDADDR],%[SDAPIN] ;release SDA \n\t"
#if I2C_PULLUP
     " sbi      %[SDAOUT],%[SDAPIN]     ;enable SDA pull-up \n\t"
...
#if __AVR_HAVE_JMP_CALL__
            " call     ass_i2c22_delay_half  ;delay  T/2 \n\t"
            " call    ass_i2c22_write       \n\t"
#else
            " rcall     ass_i2c22_delay_half  ;delay  T/2 \n\t"
            " rcall    ass_i2c22_write       \n\t"
#endif
     " ret"
     : : [SCLDDR] "I"  (SCL_DDR), [SCLPIN] "I" (SCL_PIN),
...
bool  i2c2_start_wait(uint8_t addr)
#if I2C_HARDWARE
{
  uint8_t   twst;
...
#if __AVR_HAVE_JMP_CALL__
           " call  ass_i2c22_delay_half  ;delay T/2 \n\t"
           " call  ass_i2c22_write           ;write address \n\t"
#else
           " rcall  ass_i2c22_delay_half  ;delay T/2 \n\t"
           " rcall  ass_i2c22_write           ;write address \n\t"
#endif
    " tst   r24             ;if device not busy -> done \n\t"
    " brne  __L2i2c2_start_wait_done \n\t"
#if __AVR_HAVE_JMP_CALL__
           " call  ass_i2c22_stop            ;terminate write & enable IRQ \n\t"
#else
           " rcall  ass_i2c22_stop            ;terminate write & enable IRQ \n\t"
#endif
#if I2C_MAXWAIT
    " sbiw      r30,1                   ;decrement max wait counter\n\t"
    " breq       __L2i2c2_start_wait_done  ;if zero reached, exit with false -> r24 already zero!\n\t"
#endif
#if __AVR_HAVE_JMP_CALL__
           " jmp   __L2i2c2_start_wait1   ;device busy, poll ack again \n\t"
#else
           " rjmp   __L2i2c2_start_wait1   ;device busy, poll ack again \n\t"
#endif
    "__L2i2c2_start_wait_done: \n\t"
...
#else
{
  __asm__ __volatile__
    (
     ...
     " sbi      %[SDADDR],%[SDAPIN]     ;force SDA low \n\t"
#if __AVR_HAVE_JMP_CALL__
            " call    ass_i2c22_delay_half      ;T/2 delay \n\t"
#else
            " rcall    ass_i2c22_delay_half      ;T/2 delay \n\t"
#endif
     " cbi      %[SCLDDR],%[SCLPIN]     ;release SCL \n\t"
#if I2C_PULLUP
     " sbi      %[SCLOUT],%[SCLPIN] ;enable SCL pull-up \n\t"
...
#endif
#if __AVR_HAVE_JMP_CALL__
            " call    ass_i2c22_delay_half \n\t"
#else
            " rcall    ass_i2c22_delay_half \n\t"
#endif
#if I2C_NOINTERRUPT
...
#else
{
  __asm__ __volatile__
    (
...
#if __AVR_HAVE_JMP_CALL__
            " jmp __L2i2c2_write_first \n\t"
#else
            " rjmp __L2i2c2_write_first \n\t"
#endif
     "__L2i2c2_write_bit:\n\t"
     " lsl      r24                     ;left shift into carry ;; 1C\n\t"
     "__L2i2c2_write_first:\n\t"
     " breq     __L2i2c2_get_ack           ;jump if TXreg is empty;; +1 = 2C \n\t"
#if I2C_PULLUP
     " cbi      %[SCLOUT],%[SCLPIN]     ;disable SCL pull-up \n\t"
#endif
     ...
     " nop \n\t"
     " nop \n\t"
     " brcc     __L2i2c2_write_low                                ;;+1/+2=5/6C\n\t"
     " nop                                                     ;; +1 = 7C \n\t"
...
#endif
#if __AVR_HAVE_JMP_CALL__
            " jmp      __L2i2c2_write_high                              ;; +2 = 11C \n\t"
#else
            " rjmp      __L2i2c2_write_high                              ;; +2 = 11C \n\t"
#endif
     "__L2i2c2_write_low: \n\t"
#if I2C_PULLUP
     " cbi      %[SDAOUT],%[SDAPIN]     ;disable pull-up \n\t"
...
#if I2C_DELAY_COUNTER >= 1
#if __AVR_HAVE_JMP_CALL__
            " call     ass_i2c22_delay_half  ;delay T/2             ;;+X = 11C+X\n\t"
#else
            " rcall     ass_i2c22_delay_half  ;delay T/2             ;;+X = 11C+X\n\t"
#endif
#endif
...
#if __AVR_HAVE_JMP_CALL__
            " call    ass_i2c22_wait_scl_high \n\t"
#else
            " rcall    ass_i2c22_wait_scl_high \n\t"
#endif
     " brpl     __L2delay_scl_high                              ;;+2 = 18C+X\n\t"
     "__L2i2c2_write_return_false: \n\t"
     " clr      r24                     ; return false because of timeout \n\t"
#if __AVR_HAVE_JMP_CALL__
            " jmp     __L2i2c2_write_return \n\t"
#else
            " rjmp     __L2i2c2_write_return \n\t"
#endif
     "__L2delay_scl_high: \n\t"
#if I2C_DELAY_COUNTER >= 1
#if __AVR_HAVE_JMP_CALL__
            " call ass_i2c22_delay_half  ;delay T/2             ;;+X= 18C+2X\n\t"
#else
            " rcall ass_i2c22_delay_half  ;delay T/2             ;;+X= 18C+2X\n\t"
#endif
#endif
#if __AVR_HAVE_JMP_CALL__
            " jmp  __L2i2c2_write_bit \n\t"
#else
            " rjmp  __L2i2c2_write_bit \n\t"
#endif
...
#if I2C_DELAY_COUNTER >= 1
#if __AVR_HAVE_JMP_CALL__
            " call ass_i2c22_delay_half  ;delay T/2 ;; +X = 7C+X \n\t"
#else
            " rcall ass_i2c22_delay_half  ;delay T/2 ;; +X = 7C+X \n\t"
#endif
#endif
     " clr  r25                                            ;; 17C+2X \n\t"
     ...
     " sbis %[SCLIN],%[SCLPIN]  ;wait SCL high         ;; 12C + X \n\t"
            ...
            " rcall    ass_i2c22_wait_scl_high \n\t"
#endif
     " brmi     __L2i2c2_write_return_false                       ;; 13C + X \n\t "
     " sbis %[SDAIN],%[SDAPIN]      ;if SDA hi -> return 0 ;; 15C + X \n\t"
     " ldi  r24,1                   ;return true           ;; 16C + X \n\t"
#if I2C_DELAY_COUNTER >= 1
#if __AVR_HAVE_JMP_CALL__
            " call ass_i2c22_delay_half  ;delay T/2             ;; 16C + 2X \n\t"
#else
            " rcall ass_i2c22_delay_half  ;delay T/2             ;; 16C + 2X \n\t"
#endif
#endif
     "__L2i2c2_write_return: \n\t"
     " nop \n\t "
     " nop \n\t "
#if I2C_PULLUP
     " cbi      %[SCLOUT],%[SCLPIN]     ;disable SCL pull-up \n\t"
...
#else
{
  __asm__ __volatile__
    (
...
#if I2C_DELAY_COUNTER >= 1
#if __AVR_HAVE_JMP_CALL__
            " call ass_i2c22_delay_half  ;delay T/2             ;; 4C+X \n\t"
#else
            " rcall ass_i2c22_delay_half  ;delay T/2             ;; 4C+X \n\t"
#endif
#endif
...
#if I2C_DELAY_COUNTER >= 1
#if __AVR_HAVE_JMP_CALL__
            " call ass_i2c22_delay_half  ;delay T/2             ;; 6C + 2X \n\t"
#else
            " rcall ass_i2c22_delay_half  ;delay T/2             ;; 6C + 2X \n\t"
#endif
#endif
     ...
     " sbi  %[SCLDDR],%[SCLPIN] ;force SCL low         ;; 2C \n\t"
     " cpi  r24,0                                          ;; 3C \n\t"
     " breq __L2i2c2_put_ack_low   ;if (ack=0) ;; 5C \n\t"
     " cbi  %[SDADDR],%[SDAPIN] ;release SDA \n\t"
#if I2C_PULLUP
     " sbi      %[SDAOUT],%[SDAPIN]     ;enable SDA pull-up \n\t"
#endif
#if __AVR_HAVE_JMP_CALL__
            " jmp   __L2i2c2_put_ack_high \n\t"
#else
            " rjmp   __L2i2c2_put_ack_high \n\t"
#endif
     "__L2i2c2_put_ack_low:                ;else \n\t"
#if I2C_PULLUP
     " cbi      %[SDAOUT],%[SDAPIN]     ;disable pull-up \n\t"
#endif
     " sbi  %[SDADDR],%[SDAPIN] ;force SDA low         ;; 7C \n\t"
     "__L2i2c2_put_ack_high: \n\t"
     " nop \n\t "
     " nop \n\t "
     " nop \n\t "
#if I2C_DELAY_COUNTER >= 1
#if __AVR_HAVE_JMP_CALL__
            " call ass_i2c22_delay_half  ;delay T/2             ;; 7C + X \n\t"
#else
            " rcall ass_i2c22_delay_half  ;delay T/2             ;; 7C + X \n\t"
#endif
#endif
...
#if I2C_DELAY_COUNTER >= 1
#if __AVR_HAVE_JMP_CALL__
            " call ass_i2c22_delay_half  ;delay T/2             ;; 11C + 2X\n\t"
#else
            " rcall ass_i2c22_delay_half  ;delay T/2             ;; 11C + 2X\n\t"
#endif
#endif
     "__L2i2c2_read_return: \n\t"
     " nop \n\t "
     " nop \n\t "
#if I2C_PULLUP
     " cbi      %[SCLOUT],%[SCLPIN]     ;disable SCL pull-up \n\t"
